...
public class OverscrollListView extends ListView implements OnScrollListener, View.OnTouchListener, AdapterView.OnItemSelectedListener {
    ...
    public int nHeaders = 1, nFooters = 1, divHeight = 0, delay = 1;
    ...
    /** This should be called after you finish populating the listview ! This includes any calls to  and obviously every time you re-populate the listview. */
